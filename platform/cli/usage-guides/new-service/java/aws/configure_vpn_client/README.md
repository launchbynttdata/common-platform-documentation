...
The configuration has been stored centrally within the Launch AWS Root account's parameter store AWS Secrets Manager at arn:aws:secretsmanager:us-east-2:538234414982:secret:vpn/client_test/client_config
