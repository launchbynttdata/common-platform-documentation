...
You will need these 3 properties files for your service environment inputs. 
- [Service QA `properties file` ./inputs/service.sandbox.us-east-2.tfvars](./inputs/service.qa.us-east-2.tfvars)
- [Service UAT `properties file` ./inputs/service.sandbox.us-east-2.tfvars](./inputs/service.uat.us-east-2.tfvars)
- [Service PROD `properties file` ./inputs/service.sandbox.us-east-2.tfvars](./inputs/service.prod.us-east-2.tfvars)
...
We are now going to create the ECS platform properties repository. This service is the ECS cluster that you can deploy an exclusive application too.
